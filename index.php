    ...
    <main>
        <section id="main">
            ...
            <div class="table-periodic">
                ...
                <!-- ENXOFRE -->
                <div data-id="16" class="elemento nao_metais_poliatomicos calcogenios" style="grid-column:17; grid-row:4;">
                ...
                <!-- CLORO -->
                <div data-id="17" class="elemento nao_metais_diatomicos halogênios" style="grid-column:18; grid-row:4;">
                ...
                <!-- POTÁSSIO -->
                <div data-id="19" class="elemento metais_alcalinos" style="grid-column:2; grid-row:5;">
                ...
                <!-- CÁLCIO -->
                <div data-id="20" class="elemento metais_alcalinos_terrosos" style="grid-column:3; grid-row:5;">
                ...
                <!-- GÁLIO -->
                <div data-id="31" class="elemento metais_pos_transicao familia_do_boro" style="grid-column:14; grid-row:5;">
                ...
                <!-- GERMÂNIO -->
                <div data-id="32" class="elemento semi_metais familia_do_carbono" style="grid-column:15; grid-row:5;">
                ...
                <!-- ARSÊNIO -->
                <div data-id="33" class="elemento semi_metais familia_do_nitrogenio" style="grid-column:16; grid-row:5;">
                ...
                <!-- SELÊNIO -->
                <div data-id="34" class="elemento nao_metais_poliatomicos calcogenios" style="grid-column:17; grid-row:5;">
                ...
                <!-- BROMO -->
                <div data-id="35" class="elemento nao_metais_diatomicos halogênios" style="grid-column:18; grid-row:5;">
                ...
                <!-- RUBÍDIO -->
                <div data-id="37" class="elemento metais_alcalinos" style="grid-column:2; grid-row:6;">
                ...
                <!-- ESTRÔNCIO -->
                <div data-id="38" class="elemento metais_alcalinos_terrosos" style="grid-column:3; grid-row:6;">
                ...
                <!-- ÍNDIO -->
                <div data-id="49" class="elemento metais_pos_transicao familia_do_boro" style="grid-column:14; grid-row:6;">
                ...
                <!-- ANTIMÔNIO -->
                <div data-id="51" class="elemento semi_metais familia_do_nitrogenio" style="grid-column:16; grid-row:6;">
                ...
                <!-- TELÚRIO -->
                <div data-id="52" class="elemento semi_metais calcogenios" style="grid-column:17; grid-row:6;">
                ...
                <!-- IODO -->
                <div data-id="53" class="elemento nao_metais_diatomicos halogênios" style="grid-column:18; grid-row:6;">
                ...
                <!-- CÉSIO -->
                <div data-id="55" class="elemento metais_alcalinos" style="grid-column:2; grid-row:7;">
                ...
                <!-- BÁRIO -->
                <div data-id="56" class="elemento metais_alcalinos_terrosos" style="grid-column:3; grid-row:7;">
                ...
                <!-- TÁLIO -->
                <div data-id="81" class="elemento metais_pos_transicao familia_do_boro" style="grid-column:14; grid-row:7;">
                ...
                <!-- POLÔNIO -->
                <div data-id="84" class="elemento metais_pos_transicao calcogenios" style="grid-column:17; grid-row:7;">
                ...
                <!-- FRÂNCIO -->
                <div data-id="87" class="elemento metais_alcalinos" style="grid-column:2; grid-row:8;">
                ...
                <!-- RÁDIO -->
                <div data-id="88" class="elemento metais_alcalinos_terrosos" style="grid-column:3; grid-row:8;">
                ...
                <!-- MEITNÉRIO -->
                <div data-id="109" class="elemento desconhecidos" style="grid-column:10; grid-row:8;">
                ...
                <!-- DARMSTÁDTIO -->
                <div data-id="110" class="elemento desconhecidos" style="grid-column:11; grid-row:8;">
                ...
                <!-- ROENTGÊNIO -->
                <div data-id="111" class="elemento desconhecidos" style="grid-column:12; grid-row:8;">
                ...
                <!-- NIHÔNIO -->
                <div data-id="113" class="elemento desconhecidos familia_do_boro" style="grid-column:14; grid-row:8;">
                ...
                <!-- FLERÓVIO -->
                <div data-id="114" class="elemento desconhecidos familia_do_carbono" style="grid-column:15; grid-row:8;">
                ...
                <!-- MOSCÓVIO -->
                <div data-id="115" class="elemento desconhecidos familia_do_nitrogenio" style="grid-column:16; grid-row:8;">
                ...
                <!-- LIVERMÓRIO -->
                <div data-id="116" class="elemento desconhecidos calcogenios" style="grid-column:17; grid-row:8;">
                ...
                <!-- TENESSO -->
                <div data-id="117" class="elemento desconhecidos" style="grid-column:18; grid-row:8; background: #4B0082;">
                ...
                <!-- OGANESSON -->
                <div data-id="118" class="elemento gases_nobres" style="grid-column:19; grid-row:8; background: #4B0082;">
                ...
                <!-- CÉRIO -->
                <div data-id="58" class="elemento lantanideos" style="grid-column:5; grid-row:11;">
                ...
                <!-- PRASEODÍMIO -->
                <div data-id="59" class="elemento lantanideos" style="grid-column:6; grid-row:11;">
                ...
                <!-- NEODÍMIO -->
                <div data-id="60" class="elemento lantanideos" style="grid-column:7; grid-row:11;">
                ...
                <!-- PROMÉCIO -->
                <div data-id="61" class="elemento lantanideos" style="grid-column:8; grid-row:11;">
                ...
                <!-- SAMÁRIO -->
                <div data-id="62" class="elemento lantanideos" style="grid-column:9; grid-row:11;">
                ...
                <!-- EURÓPIO -->
                <div data-id="63" class="elemento lantanideos" style="grid-column:10; grid-row:11;">
                ...
                <!-- GADOLÍNIO -->
                <div data-id="64" class="elemento lantanideos" style="grid-column:11; grid-row:11;">
                ...
                <!-- TÉRBIO -->
                <div data-id="65" class="elemento lantanideos" style="grid-column:12; grid-row:11;">
                ...
                <!-- DISPRÓSIO -->
                <div data-id="66" class="elemento lantanideos" style="grid-column:13; grid-row:11;">
                ...
                <!-- HÓLMIO -->
                <div data-id="67" class="elemento lantanideos" style="grid-column:14; grid-row:11;">
                ...
                <!-- ÉRBIO -->
                <div data-id="68" class="elemento lantanideos" style="grid-column:15; grid-row:11;">
                ...
                <!-- TÚLIO -->
                <div data-id="69" class="elemento lantanideos" style="grid-column:16; grid-row:11;">
                ...
                <!-- ITÉRBIO -->
                <div data-id="70" class="elemento lantanideos" style="grid-column:17; grid-row:11;">
                ...
                <!-- LUTÉCIO -->
                <div data-id="71" class="elemento lantanideos" style="grid-column:18; grid-row:11;">
                ...
                <!-- TÓRIO -->
                <div data-id="90" class="elemento actinideos" style="grid-column:5; grid-row:12;">
                ...
                <!-- PROTACTÍNIO -->
                <div data-id="91" class="elemento actinideos" style="grid-column:6; grid-row:12;">
                ...
                <!-- URÂNIO -->
                <div data-id="92" class="elemento actinideos" style="grid-column:7; grid-row:12;">
                ...
                <!-- NETÚNIO -->
                <div data-id="93" class="elemento actinideos" style="grid-column:8; grid-row:12;">
                ...
                <!-- PLUTÔNIO -->
                <div data-id="94" class="elemento actinideos" style="grid-column:9; grid-row:12;">
                ...
                <!-- AMERÍCIO -->
                <div data-id="95" class="elemento actinideos" style="grid-column:10; grid-row:12;">
                ...
                <!-- CÚRIO -->
                <div data-id="96" class="elemento actinideos" style="grid-column:11; grid-row:12;">
                ...
                <!-- BERQUÉLIO -->
                <div data-id="97" class="elemento actinideos" style="grid-column:12; grid-row:12;">
                ...
                <!-- CALIFÓRNIO -->
                <div data-id="98" class="elemento actinideos" style="grid-column:13; grid-row:12;">
                ...
                <!-- EINSTÊNIO -->
                <div data-id="99" class="elemento actinideos" style="grid-column:14; grid-row:12;">
                ...
                <!-- FÉRMIO -->
                <div data-id="100" class="elemento actinideos" style="grid-column:15; grid-row:12;">
                ...
                <!-- MENDELÉVIO -->
                <div data-id="101" class="elemento actinideos" style="grid-column:16; grid-row:12;">
                ...
                <!-- NOBÉLIO -->
                <div data-id="102" class="elemento actinideos" style="grid-column:17; grid-row:12;">
                ...
                <!-- LAURÊNCIO -->
                <div data-id="103" class="elemento actinideos" style="grid-column:18; grid-row:12;">
